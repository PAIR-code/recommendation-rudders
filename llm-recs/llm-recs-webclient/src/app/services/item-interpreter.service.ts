...
import {
  expInterpTempl,
  characteristicsTempl,
} from '../../lib/recommender-prompts/item-interpreter';
import { fillTemplate } from 'ts-llmt/dist/llm';
import { matchFewShotTemplate } from 'ts-llmt';
import {
  ErrorResponse,
  isErrorResponse,
} from 'src/lib/simple-errors/simple-errors';
...
export class ItemInterpreterService {
  ...
  async interpretItemText(
    text: string
  ): Promise<InterpretedItem | ErrorResponse> {
